...
transfer(MT::ViTerm.db_path("common-main"), "dic = -2")
transfer(MT::ViTerm.db_path("common-main"), "dic = -1 and tab = 1")
transfer(MT::ViTerm.db_path("common-main"), "dic = -3")
transfer(MT::ViTerm.db_path("common-user"), "dic = -1 and tab > 1")

transfer(MT::ViTerm.db_path("wnovel-main"), "dic > 0 and tab = 1")
transfer(MT::ViTerm.db_path("wnovel-user"), "dic > 0 and tab > 1")
