...
{"train", "dev", "test"}.each do |type|
  array, l_id = read_file "var/inits/cvmtl/POS/ctb5/#{type}.char.bmes", l_id
  terms.concat(array)
  array.each do |term|
...
DB.open("sqlite3:var/cvmtl/dicts/ctbv5-data.db") do |db|
...
DB.open("sqlite3:var/cvmtl/dicts/ctbv5-freq.db") do |db|
