...
class CE_DICT
  ...
  def export_ce_dict!
    ...
    dict = Engine::BaseDict.load("cc_cedict", mode: 0)
  ...
  def export_tradsim!
    ...
    tswords = Engine::BaseDict.new(Utils.inp_path("autogen/tradsimp-words.dict"))
    ...
    dict = Engine::BaseDict.load("_tradsim", mode: 0)
  ...
  def export_pinyins!
    ...
    dict = Engine::BaseDict.load("_binh_am", mode: 0)
