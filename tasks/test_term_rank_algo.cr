...
def calc(size : Int32, rank = 1)
  MAP[(size &- 1) &* 3 &+ rank]? || size &* (rank &* 2 &+ 7) &* 2
end
...
assert_gt [{2, 1}, {1, 2}], [{3, 0}]
assert_gt [{2, 2}, {1, 1}], [{3, 0}]
puts
...
# assert_gt [{7, 0}], [{6, 1}, {1, 1}]
assert_gt [{7, 0}], [{5, 2}, {2, 1}]
assert_gt [{7, 2}], [{6, 2}, {1, 2}]
assert_gt [{7, 1}], [{5, 2}, {2, 2}]
assert_gt [{7, 1}], [{4, 2}, {3, 2}]
