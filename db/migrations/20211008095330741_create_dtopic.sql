...
CREATE TABLE dtopics (
  ...
  brief text not null default '', -- short description, generated from first tpost

  ttype int not null default '0'; -- topic type
  ...
  utime bigint not null default '0', -- update time
  atime bigint not null default '0', -- access time
