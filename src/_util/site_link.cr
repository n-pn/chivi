module CV::SiteLink
  ...
  def info_url(sname : String, snvid : String)
    ...
    when "uuks"     then "https://www.uuks.org/b/#{snvid}/"
    ...
    when "yannuozw" then "http://www.yannuozw.com/yn/#{snvid}.html"
    when "kanshu8"  then "http://www.kanshu8.net/book/#{snvid}/"
  ...
  def text_url(sname : String, snvid : String, schid : String)
    ...
    when "uuks"     then "https://www.uuks.org/b/#{snvid}/#{schid}.html"
    ...
    when "yannuozw" then "https://www.yannuozw.com/yn/#{snvid}/#{schid}.html"
    when "kanshu8"  then "http://www.kanshu8.net/book/#{snvid}/read_#{schid}.html"
