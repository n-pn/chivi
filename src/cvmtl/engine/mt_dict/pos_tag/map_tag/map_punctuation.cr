module MT::PosTag
  PUNCT_MAP = {
    ...
    "⟨"  => make(:title_st1, MtlPos.flags(Boundary, NoWsAfter, CapAfter)),
    "<"  => make(:title_st2, MtlPos.flags(Boundary, NoWsAfter, CapAfter)),
    "‹"  => make(:title_st3, MtlPos.flags(Boundary, NoWsAfter, CapAfter)),
    ...
    "["  => make(:brack_st1, MtlPos.flags(Boundary, NoWsAfter, CapAfter)),
    "{"  => make(:brack_st2, MtlPos.flags(Boundary, NoWsAfter, CapAfter)),
