...
#   def get_chap(seed : Wnstem, chap : Chinfo)
...
#   @[AlwaysInline]
#   def save_txt_file(seed : Wnstem, chap : Chinfo) : String
#     txt_path = gen_txt_path(seed.sname, seed.s_bid, chap.s_cid)
...
#   @[AlwaysInline]
#   def read_txt_from_zip(seed : Wnstem, chap : Chinfo)
