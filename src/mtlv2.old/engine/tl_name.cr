...
#   def initialize(@vdict : V2Dict)
#     @bdict = V2Dict.regular
#   end
...
#   HV_MTL = MtCore.new([V2Dict.hanviet, V2Dict.surname], "[cv]")
...
#   def find_defined(vdict : V2Dict, input : String, tags : Array(String))
