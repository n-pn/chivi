module MT::TlRule
  ...
  def fold_noun_junction!(junc : BaseNode, prev = junc.prev?, succ = junc.succ?)
  ...
  def fold_noun_junction_special!(noun : BaseNode, junc : BaseNode, tail = junc.succ)
  ...
  # def should_fold_noun_junction?(noun : BaseNode, concoord : BaseNode) : Bool
