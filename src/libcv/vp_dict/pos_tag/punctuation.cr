struct CV::PosTag
  PUNCTS = {
    ...
    {"wpc", "Perct", Pos::Quantis | Pos::Puncts},   # percentage and permillle signs: ％ and ‰ of full length; % of half length
    {"wqt", "Squanti", Pos::Quantis | Pos::Puncts}, # full or half-length unit symbol ￥ ＄ ￡ ° ℃  $
