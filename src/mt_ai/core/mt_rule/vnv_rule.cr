...
class MT::AiCore
  ...
  def split_vnv!(vv_node : MtNode, vv_body : DefnData | MtNode, vp_body : Array(MtNode)) : MtNode
    ...
    MtNode.new(zstr: tl_zstr, body: DefnData.auto_fix(vstr), epos: :VV, from: tl_node.upto)
  end
