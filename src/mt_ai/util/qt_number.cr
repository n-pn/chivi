struct MT::QtNumber
  ...
  POWER_OF_E4 = {"", " mươi", " trăm", " nghìn", " vạn", " mươi vạn", " trăm vạn", " nghìn vạn", " ức"}
  POWER_OF_E3 = {"", " mươi", " trăm", " nghìn", " mươi nghìn", " trăm nghìn", " triệu", " mươi triệu", " trăm triệu", " tỉ"}
  ...
  def initialize(mode : Rmode = :default)
    case mode
    when .keep_power?
      @scale = 4
      @to_vi = POWER_OF_E4
  ...
  def self.translate(text : String, mode : Rmode = :default)
    new(mode).translate(text)
  end
