require "../src/mt_sp/data/sq_tran"
...
#     SP::SqTran.new(zstr, vstr, "qt_v2").upsert!(db: db)
#   end
# end

# inputs = SP::SqTran.get_all(db: SP::SqTran.db)

# inputs.select! do |entry|
#   hvname = MT::QtCore.tl_hvname(entry.zstr)
