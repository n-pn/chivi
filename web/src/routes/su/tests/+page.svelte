          ...
          [
            ...
            [
              [
                ...
                '',
                [
                  ['CLP', 1, 1, '', [['M', 1, 1, '', '块', 'khối', 3]]],
                  ['NP', 8, 2, '', [['NN', 8, 2, '', '石头', 'tảng đá', 5]]],
                  [
                    'CP',
                    2,
                    6,
              ...
              ['NP', 10, 2, '', [['NN', 10, 2, '', '表面', 'mặt ngoài', 5]]],
              [
                'VP',
                12,
                8,
                ...
                [
                  ...
                  [
                    ...
                    '',
                    [
                      ['NP', 19, 1, '', [['NN', 19, 1, '', '斑', 'đốm', 5]]],
                      ['ADJP', 18, 1, '', [['JJ', 18, 1, '', '银', 'bạc', 3]]],
                      [
                        'CP',
                        14,
                        4,
                      ...
                      [
                        ...
                        [
                          ...
                          [
                            ...
                            '',
                            [
                              ['NN', 25, 2, 'Npos Nper', '小姐', 'tiểu thư', 5],
                              ['NN', 24, 1, '', '官', 'quan', 5],
                              ['NN', 22, 2, '', '舰务', 'hạm vụ', 6],
                            ],
                          ],
                      ...
                      [
                        ...
                        [
                          [
                            ...
                            '',
                            [
                              ['NN', 37, 2, '', '光泽', 'sáng bóng', 5],
                              ['NN', 35, 2, 'Ndes', '金属', 'kim loại', 5],
                            ],
                          ],
                          [
                            'CP',
          ...
          [
            ...
            [
              [
                ...
                '',
                [
                  ['PN', 42, 2, '', '自己', 'bản thân', 3],
                  [
                    'NP',
                    40,
                    2,
                    'Npos Nper',
                    [['NR', 40, 2, 'Npos Nper', '方鸻', 'Phương Hằng', 2]],
                  ],
                ],
              ],
              [
...
<article class="article island">
  ...
  <div class="input">
    <label>Từ vị trí: <input type="number" bind:value={zfrom} /></label>
    <label>Tới vị trí: <input type="number" bind:value={zupto} /></label>
  </div>
