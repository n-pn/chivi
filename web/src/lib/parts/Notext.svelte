...
<article class="notext cvdata m-article">
  ...
  {:else if lvl0_seeds.includes(chinfo.sname)}
    ...
    <p />
  {:else if lvl1_seeds.includes(chinfo.sname)}
    <p>
